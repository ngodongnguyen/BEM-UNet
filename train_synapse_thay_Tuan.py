...
def main(config):
    ...
    min_loss = 999
    best_mean_dice = 0.0  # Dice càng cao càng tốt
    best_mean_hd95 = float('inf')  # HD95 càng thấp càng tốt
    mean_dice, mean_hd95 = 0.0, float('inf')
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        # if loss < min_loss:
        # TODO: NGUYEN XEM LAI
        if best_mean_dice < mean_dice or best_mean_hd95 > mean_hd95:
            best_mean_dice, best_mean_hd95 = mean_dice, mean_hd95
